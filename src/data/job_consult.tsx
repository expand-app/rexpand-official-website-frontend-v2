...
export const campConsultModalData: ConsultModalData = {
    ...
    content: <>
        <div className='mb-1'>扫描二维码或者 <Link href='https://work.weixin.qq.com/ca/cawcde49bb005d5c7d' target='_blank' style={{color: '#008A27'}}>点击这里</Link></div>
        <div>联系Rexpand课程顾问立即报名</div>
    </>,
} ;
...
export const daConsultModalData: ConsultModalData = {
    ...
    content: <>
        <div className='mb-1'>扫描二维码或者 <Link href='https://work.weixin.qq.com/ca/cawcdeb6941b88b03e' target='_blank' style={{color: '#008A27'}}>点击这里</Link></div>
        <div>联系Rexpand课程顾问立即报名</div>
    </>,
} ;
...
export const qiConsultModalData: ConsultModalData = {
    ...
    content: <>
        <div className='mb-1'>扫描二维码或者 <Link href='https://work.weixin.qq.com/ca/cawcdec5b629f54ba9' target='_blank' style={{color: '#008A27'}}>点击这里</Link></div>
        <div>联系Rexpand课程顾问立即报名</div>
    </>,
} ;
...
export const imConsultModalData: ConsultModalData = {
    ...
    content: <>
        <div className='mb-1'>扫描二维码或者 <Link href='https://work.weixin.qq.com/ca/cawcde400d65e0859e' target='_blank' style={{color: '#008A27'}}>点击这里</Link></div>
        <div>联系Rexpand课程顾问立即报名</div>
    </>,
} ;
...
export const fsdConsultModalData: ConsultModalData = {
    ...
    content: <>
        <div className='mb-1'>扫描二维码或者 <Link href='https://work.weixin.qq.com/ca/cawcdefb3aa5b5a6c1' target='_blank' style={{color: '#008A27'}}>点击这里</Link></div>
        <div>联系Rexpand课程顾问立即报名</div>
    </>,
} ;
...
export const consultModalData: ConsultModalData = {
    ...
    content: <>
        <div className='mb-1'>扫描二维码或者 <Link href='https://work.weixin.qq.com/ca/cawcdefe06cca86b8b' target='_blank' style={{color: '#008A27'}}>点击这里</Link></div>
