...
export const quantitativeInvestmentOutlineData: OutlineData = {
    ...
    },
    {
        ...
        subjectDescription: '这部分将协助客户进行量化研究Quant Research的工作。客户会提供给我们一些他们想要研究的想法，我们负责和研究回测这些想法是否可行。我们需要帮助客户完成的一个工作是测试将经济增长、通胀、利率等宏观经济数据融入量化模型对于目前我们的一只量化基金有没有显著的收益上的提升。',
        courseList: [{
