  ...
  subjects: [
    {
      ...
      subjectDescription:
        "这部分主要介绍团队和项目情况，同时通过实践来提高对财务建模的理解和能力。",
      courseList: [
        {
    ...
    },
    {
      ...
      subjectDescription:
        "在这部分中，你的客户是一家全球领先的信息和通信技术（ICT）解决方案提供商。该客户正在进行公司重组，并已经剥离了其研发部门。我们需要帮助他们为联邦税务目的对研发部门进行估值。在这次项目中，你将基于客户提供的财务数据预测现金流，计算加权平均资本成本（WACC）模型以贴现现金流，并进行估值以估算目标实体的内在价值。",
      courseList: [
        {
...

    {
      ...
      subjectDescription:
        "在这部分中，你的客户是美国市场上领先的奢侈家具和室内品牌。随着公司的发展以及战略目标的制定，准确的财务预测变得尤为重要。在这次项目中，你将与客户的财务和会计团队合作，收集历史财务数据和当前的运营指标。你将分析市场趋势、销售预测和运营数据，以预测收入、成本和潜在的资本支出。建立一个滚动预测机制，以便根据动态的商业环境进行定期更新。",
      courseList: [
        {
          name: "第9周：开发财务预算模型",
          sections: [
