...
export const MobileView = () => {
  ...
  return (<>
      ...
      <>
        ...
        <div 
          className={clsx('bg-white relative section',styles.m_section2, styles.m_internship_project_section)}
          style={{
...
export const PCView = () => {
  ...
  return (<>
      ...
      <>
        ...
        <div className={`flex flex-col items-center  justify-center page-banner ${styles.banner_container}`}>
          <div className={styles.swiper_container}>
            <Swiper pagination={true} 
              modules={[Pagination]} 
              className={styles.swiper}>
              <SwiperSlide>
                <Image src={bannerImg} alt="" style={{height: '100%', width: '100%'}}/>
              </SwiperSlide>
              <SwiperSlide>
                <Image src={bannerImg} alt="" style={{height: '100%', width: '100%'}}/>
              </SwiperSlide>
