      ...
      <main className='mt-24 mb-12'>
        ...
        <div className=" container mx-auto max-w-screen-lg px-4">
          ...
          <div className='bg-white px-12 py-12 mt-2'>
            ...
            <span className='font-bold'>免责声明</span><br />
            ...
            <span className='font-bold'>隐私保护</span><br />
