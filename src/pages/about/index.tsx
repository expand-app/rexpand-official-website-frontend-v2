...
function MobileView () {
    return <div>
        ...
        <div className="">  
          ...
          <div className={clsx('bg-white m-section', styles.section1)}>
          ...
          <div className={clsx('bg-white m-section', styles.section2)} style={{backgroundColor: '#F2F9F4'}}>
          ...
          <div className={clsx('m-section', styles.section3)} style={{backgroundImage: `url(${xpqnBgImage.src})`}}>
          ...
          <div className={clsx('m-section', styles.section4)} style={{background: `linear-gradient(180deg, rgba(238, 255, 252, 0.3) 0%, rgba(125, 209, 147, 0.3) 100%) white`}}>
