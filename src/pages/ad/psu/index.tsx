...
import NYUSvg from "@/assets/ad/university/Pennsylvania State University.svg";
import {
  AD_LINK,
  COMPANY_LIST,
  COMPANY_LIST_MIN,
            ...
            >
              <Box fontFamily={"Poppins_Bold"} sx={{ flex: 1 }}>
                <Box component="h1" fontSize={60} color={"#333"}>
                  Private invitation to Pennsylvania State University alumni
                  group
                </Box>
        ...
        <Box sx={{ pb: 16 }} className={clsx(styles.m_topBg)}>
          ...
          <Box className={"container mx-auto "} sx={{ px: 8 }}>
            <Stack className={clsx("pt-14 w-full  ")}>
              ...
              >
                Private invitation to Pennsylvania State University alumni group
              </Box>
              <Box
                component={"ul"}
