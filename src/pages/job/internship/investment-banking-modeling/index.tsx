...
import {
  internshipMenusData,
  investmentBankingModelingSightViewData,
} from "@/data/internship";
import Outline from "@/pages/job/components/Outline/Outline";
import {
  investmentBankingModelingFAQData,
  investmentBankingModelingOutlineData,
} from "@/data/investment_banking_modeling_internship";
          ...
          <div className="flex flex-col items-center justify-center px-22px">
            <div className={styles.m_banner_text}>
              ...
              <h2 className={clsx(styles.m_banner_subtitle)}>
                使用金融建模的方法来帮助企业客户在财务规划和决策中做出精确的预测和评估
              </h2>
        ...
        >
          <div className="px-22px">
            ...
            <div className="flex flex-col">
              ...
              >
                <div>
                  实习生将在一家咨询公司的Transaction Advisory Services (TAS)
                  部门任职，将为客户提供交易和并购过程中的金融建模（Financial
                  Modeling)支持，协助进行公司估值(Valuation)
                  和财务预测(Financial
                  Planning)。利用Excel作为主要的建模工具，展现出深厚的财务知识基础，精通阅读和分析财务报表。能够高效地将客户的商业模式转化为详细的Excel模型，从而辅助企业客户在财务规划和决策过程中做出更加精确的预测和评估。
                </div>
              </div>
