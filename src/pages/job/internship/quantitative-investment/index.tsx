...
import {
  internshipMenusData,
  quantitativeInvestimentSightViewData,
} from "@/data/internship";
import Outline from "@/pages/job/components/Outline/Outline";
import {
  quantitativeInvestmentFAQData,
  quantitativeInvestmentOutlineData,
} from "@/data/quantitative_investment_internship";
    ...
    <>
      ...
      <div>
        ...
        <JobConsultModal
          ...
          qrImage={qiConsultModalData.qrImage}
          content={qiConsultModalData.content}
        />{" "}
      </div>
    </>
  );
...
export const MobileView = ({ onBannerBtnClick }: Props) => {
  ...
  return (
    <div>
      ...
      <main className="">
        <div
          className={`${styles.m_banner_container} internship_banner_container flex flex-col items-center relative`}
        >
          <div className="flex flex-col items-center justify-center px-22px">
            <div className={styles.m_banner_text}>
              ...
              <h2 className={clsx(styles.m_banner_subtitle)}>
                使用Python进行量化风险管理和投资策略，包括VaR模型评估和战略资产配置建议
              </h2>
              {/* <VideoCard 
              ...
              <Image
                src={require("@/assets/temp/2.png")}
                alt=""
                style={{ margin: "40px auto", width: "auto", maxHeight: 240 }}
              />
        ...
        <div
          className={clsx(
            "bg-white section m_internship_intro_section",
            styles.section1
          )}
        >
          <div className="px-22px">
            <SectionTitle
              title="实习介绍"
              className="m_internship_intro_title"
            />

            <div className="flex flex-col">
              <div
                className={clsx(
                  "flex-1 flex items-center m_internship_practise_intro_text"
                )}
              >
                <div>
                  实习生将在一家咨询公司的Investment Management Services (IMS)
                  部门任职，将支持投资组合经理执行量化风险管理服务和制定量化投资策略。这个职位的核心工作包括运用Python作为主要分析工具，通过使用价值在风险（VaR）模型进行风险评估与量化，辅助客户在风险管理上的决策。工作中将利用多因子回归模型等量化方法，为客户提供战略性的资产配置建议（Strategic
                  Asset
                  Allocation）。通过高级量化分析技术，帮助客户优化投资组合表现并实现量化风险控制（Quantitative
                  Risk Management)。
                </div>
              </div>
        ...
        <div className="bg-white section m_internship_outline_section">
          <div className="px-12px">
            <SectionTitle
              title="项目大纲"
              className="m_internship_outline_title"
            />
...
export const PCView = ({ onBannerBtnClick }: Props) => {
  ...
  useEffect(() => {
    ...
    const debouncedSetActiveFloatMenuIndex = _.debounce(
      setActiveFloatMenuIndex,
      200
    );
  ...
  return (
    <div>
      ...
      <main className="">
        ...
        <div
          className={clsx(
            "bg-white section internship_intro_section",
            styles.section1
          )}
        >
          ...
          <div className="container mx-auto">
            ...
            <div className="flex flex-col md:flex-row">
              <div className="flex justify-end" style={{ width: "28vw" }}>
                <Image
                  src={introImage}
                  alt="实习介绍"
                  className="object-contain lg:mr-8 h-full w-auto"
                />
              </div>
              ...
              <div className="flex flex-col md:flex-row">
                <div className="flex justify-end">
                  <Image
                    src={sightImage}
                    alt="项目亮点"
                    className="object-contain lg:mr-24 h-full w-auto"
        ...
        <div className="bg-white section internship_outline_section">
          <div
            ...
            className="internship_section_anchor"
          ></div>
          <div className="container mx-auto">
            <SectionTitle
              title="项目大纲"
              className="internship_outline_title"
            />
