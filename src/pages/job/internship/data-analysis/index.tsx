...
import {
  dataAnalysisFAQData,
  dataAnalysisOutlineData,
} from "@/data/data_analysis_internship";
        ...
        >
          <div className="px-22px">
            ...
            <div className="flex flex-col">
              ...
              >
                <div>
                  实习生将在一家咨询公司的Marketing Analytics Services (MAS)
        ...
        >
          ...
          <div className="container mx-auto">
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div
                className={clsx(
                  "flex-1 flex items-center internship_practise_intro_text"
                )}
              >
                <div>
                  实习生将在一家咨询公司的Marketing Analytics Services (MAS)
