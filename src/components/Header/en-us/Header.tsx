...
import { consultModalDataEnUs } from "@/data/job_consult";
  ...
  return (
    <nav className={combinedClassName}>
                ...
                <ul>
                  ...
                  <li>
                    <Link
                      ...
                      onClick={onMenuLinkClick}
                    >
                      Quantitative Investment Internship
                    </Link>
                  </li>
                  <li>
                    <Link
      ...
      <JobConsultModal
        ...
        qrImage={consultModalDataEnUs.qrImage}
        content={consultModalDataEnUs.content}
      />
    </nav>
  );
};
