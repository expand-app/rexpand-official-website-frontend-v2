...
const MobileView = ({
  ...
  return <div className={containerClassNames}>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50">
        ...
        <div className={clsx("", styles.m_modal_content)} style={{backgroundColor: 'transparent'}}>
          <button
...
const PCView = ({
    ...
    return <div className={containerClassNames}>
        {open && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className={clsx("fixed inset-0 bg-black")} style={{
            opacity: config?.maskOpacity,
          }}></div>
          <div className={clsx("", styles.modal_content)} style={{
            ...
            <div>
                {videoPath == null ? 
                    <div>未指定视频</div>:
                    <div className={clsx('', styles.video_container)} style={{
                      width: config?.videoWidth,
                    }}>
                        <video className='' src={videoPath} autoPlay controls/>
                    </div>
